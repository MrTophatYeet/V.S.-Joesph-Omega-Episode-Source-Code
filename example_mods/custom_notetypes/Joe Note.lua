function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Joe Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'NOTE_joe'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'Joe Note' then
		setProperty('health', 0.01);
		playSound('vinethud', 1.5);
	end
end
